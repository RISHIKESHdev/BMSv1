...
public class CardSQLQuery {
    ...
    static final String UPDATE_DEACTIVATE_CARD = "UPDATE Card_Master SET is_Active='False' WHERE Id=?";
    ...
    static final String INSERT_DEBIT_CARD="";
    static final String INSERT_CO_BRAND_CREDIT_CARD="";
